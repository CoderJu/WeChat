 ...
 * 类名：JssdkUtil
 * 开发人员: Ju
 * 创建时间: 2018/7/15 15:07
 * 描述: 引入JS-SDK时获取需要注入的参数
 * 版本：V1.0
 */
public class JssdkUtil {
    ...
    public static Map<String, Object> getWxConfig(HttpServletRequest request) {
        ...
        String secret =PropertyUtil.getValueByKey("WeChat.properties","appsecret");
        ...
        JSONObject json = JssdkUtil.httpRequest(url, "GET", null);
        ...
        if (json != null) {
            ...
            json = JssdkUtil.httpRequest(url, "GET", null);
            if (json != null) {
